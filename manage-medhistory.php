...
<td>
<?php
$sql1=mysqli_query($con,"select doctors.doctorName as docname,appointment.*  from appointment join doctors on doctors.id=appointment.doctorId where appointment.userId='".$_SESSION['id']."'");

$row1=mysqli_fetch_array($sql1);

?>
<a href="<?php echo $row1['link'];?>">Connect</i></a>
