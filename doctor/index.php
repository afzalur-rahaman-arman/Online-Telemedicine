...
<html lang="en">
	...
	<body>
		<div style="background-image: url('bg.jpg');">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2> Telemedicine | Doctor Login</h2></a>
				</div>
 ...
 <span class="current-year"></span><span class="text-bold text-uppercase">Telemedicine</span>. <span>Created by Afzalur Rahaman
 </span>
